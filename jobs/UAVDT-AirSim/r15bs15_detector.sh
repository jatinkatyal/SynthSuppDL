...
python /home/jatin/work/tracking_analysis/src/utils/traktor_objdet.py --dataset=/home/jatin/datasets/UAVDT/ --model_prefix=R15bS15 --mode="train15-b" --synth_dataset=/home/jatin/datasets/AirSim-UAV-Synth/data/
