...
python /home/jatin/work/tracking_analysis/src/utils/traktor_reid.py --data=$SLURM_TMPDIR/UAVDT_reid --syndata=$SLURM_TMPDIR/AirSim-reid-data/reid-data --mode=R15bS15
exit
