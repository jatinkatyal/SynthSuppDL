...
python /home/jatin/work/tracking_analysis/src/utils/traktor_reid.py --data=$SLURM_TMPDIR/mot17-reid/ --syndata=$SLURM_TMPDIR/reid/ --dataset_class='MOT' --mode=R3eS18e
exit
