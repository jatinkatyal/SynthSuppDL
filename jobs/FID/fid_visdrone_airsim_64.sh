...
python /home/jatin/work/tracking_analysis/src/utils/fidscores.py --source=$SLURM_TMPDIR/VisDrone/sequences --target=$SLURM_TMPDIR/airsim/data/Sequences --type="VisDrone" --dims=64 --output=/home/jatin/results/fid
exit
