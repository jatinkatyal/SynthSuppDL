...
python /home/jatin/work/tracking_analysis/src/utils/fidscores.py --source=$SLURM_TMPDIR/UAVDT/UAV-benchmark-M --target=$SLURM_TMPDIR/airsim/data/Sequences --type="UAVDT" --dims=64 --output=/home/jatin/results/fid
exit
