...
python /home/jatin/work/tracking_analysis/src/utils/traktor_reid.py --data=$SLURM_TMPDIR/VisDrone-reid-train_all-class --syndata=$SLURM_TMPDIR/AirSim-reid-data/reid-data --dataset_class='VisDrone' --mode=R5fS25
exit
