...
python3 -m torch.distributed.launch --nproc_per_node=4 --use_env main_track.py  --output_dir ./output_mix --dataset_file mix --coco_path mix --batch_size 4 --resume output_crowdhuman/crowdhuman_final.pth --with_box_refine --num_queries 500  --epochs 20 --lr_drop 10
